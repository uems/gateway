...
function CashTicketService() {
  ...
  this.allPaymentXids = function() {
    return history.findTicketGrantingOperations().then(function(operations) {
  ...
  this.getPaymentsByIp = function(ip, day, personSvc) {
    return history.findAcceptCashByIp(ip, day).then(function(transitions) {
